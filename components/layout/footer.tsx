          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/profile.php?id=61553617572748" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-lau-cam-yellow transition-colors">
                  <Facebook className="h-5 w-5" />
                </a>
                <a href="https://www.instagram.com/_laucam_/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-lau-cam-yellow transition-colors">
